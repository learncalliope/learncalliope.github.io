...
var word = [["LED MATRIX", "Red light grid can be controlled individually"], ["RGB", "Led with countless other colors"], 
["SPEAKER", "Play beep and music"], ["Knobs", "A and B buttons programmed to do whatever you want"], 
["TOUCH PINS", "Connect battery, sensors like temperature or moisture"], ["POSITION SENSOR", "allows the Calliope mini to measure, for example, in which direction and at what speed it is being moved."],
["LIGHT SENSOR", "measure the brightness in the area"], ["TEMPERATURE SENSOR", "helps to find whether the room is chilly or hot"],
["VOLUME SENSOR", "Measure the noise in the area"], ["COMPASS", "the Calliope mini can recognize in which direction and at what speed it is being moved."],
["WIRELESS", "send signals from one Calliope mini to another via radio and thus pass on messages."], 
["BLUETOOTH", "Connect phone and transfer data without cables"], ["GROVE ADAPTERS", "Extension modules can be connected to the two connecting plugs in order to measure light or color"], 
["MOTOR PINS", "Transform board into robot or a self-driving car"], ["BATTERY CONNECTION", "Power your Calliope on the go"], 
["USB CONNECTION", "Using cable transfer program to your board"], ["PROCESSOR", "provides enough computing power for all ideas and projects you can think of"],
["STATUS LED", "Yellow light on the top left corner"], ["RESET BUTTON", "Go back to starting state"]]
